...
project = "hp_PllayDTM_" + args.data
...
sweep_config = {
    ...
    "description": f"Hyperparameter search of Pllay on {args.data} using 100/400 train data"
}
...
if __name__ == "__main__":
    ...
    train_pipeline = partial(train_val_wandb, Pllay, None, x_path_list[0], y_path, seed, project=project)

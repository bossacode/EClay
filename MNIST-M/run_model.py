...
from models import Cnn, EcCnn_i, EcCnn, EcCnnDTM_i, EcCnnDTM, ResNet18, EcResNet_i, EcResNet, EcResNetDTM_i, EcResNetDTM
...
if __name__ == "__main__":
    ...
    for train_size in train_size_list:
        project = "MNIST-M_data"      # used as project name in wandb

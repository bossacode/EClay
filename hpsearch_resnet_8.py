...
project = "hp_ResNest18_8_300" + args.data
...
if __name__ == "__main__":
    ...
    train_pipeline = partial(train_pipeline_wandb, ResNet18_8, None, x_path_list[0], y_path, seed, project=project)

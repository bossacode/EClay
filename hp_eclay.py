...
parser.add_argument("-hid", "--hidden", nargs="+", type=int, help="hidden feature dimensions of ECLay")
args = parser.parse_args()

project = "hp_EClayDTM_" + args.data
...
sweep_config = {
    ...
    "parameters": {
        ...
        "model_params": {
            "parameters": {
                ...
                "hidden_features": {"value": args.hidden}
            }
        },
    ...
    "description": f"Hyperparameter search of EClay on {args.data} using 100/400 train data"
}
...
if __name__ == "__main__":
    ...
    train_pipeline = partial(train_val_wandb, EClay, None, x_path_list[0], y_path, seed, project=project)

...
if __name__ == "__main__":
    ...
    for cn in range(len_cn):
        ...
        for n_sim in range(ntimes):
            ...
            print("-"*30)
            train_dataset = MNISTCustomDataset(x_dir_list[cn], y_dir, mode="train", random_seed=rand_seed_list[n_sim], val_size=0.3)
            val_dataset = MNISTCustomDataset(x_dir_list[cn], y_dir, mode="val", random_seed=rand_seed_list[n_sim], val_size=0.3)

...
from resnet_train import CustomDataset, eval, ResNet18, run_name, len_cn, file_cn_list, x_dir_list, y_dir, ntimes
    ...
    for cn in range(len_cn):
        ...
        for n_sim in range(ntimes):
            ...
            if record_test_info:
                ...
                test_info[ResNet18.__name__].append({"sim" + str(n_sim+1):(test_acc, test_loss)})
        ...
        if record_test_info:
            ...
            with open(test_info_dir + "/" + f"test_info.json", "w", encoding="utf-8") as f:
                json.dump(test_info[ResNet18.__name__], f, indent="\t")

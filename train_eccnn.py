...
if __name__ == "__main__":
    ...
    for i_cn in range(len_cn):
        ...
        for n_sim in range(1, config["ntimes"]+1):
            ...
            # train_test_wandb(EC_CNN_2, config, x_path_list[i_cn], y_path, seed, weight_path, True, False, project, group, job_type)
            # train_test_wandb(EC_CNN_2, config, x_path_list[i_cn], y_path, seed, weight_path, True, True, project, group, job_type)

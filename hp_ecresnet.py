...
project = "hp_ECResNet_" + args.data
...
sweep_config = {
    ...
    "parameters": {
        ...
        "lr_res": {"values": [0.001, 0.005, 0.01]},
        "lr_topo": {"values": [0.0001, 0.0005, 0.001, 0.005]},
        "lr_fc": {"values": [0.0001, 0.0005, 0.001, 0.005, 0.01]},
        "model_params": {
            "parameters": {
                # ResNet Parameters
                "in_channels": {"value": 1},
                # block=ResidualBlock,
                "block_cfg": {"value": [2,2]}, 
                "filter_cfg": {"value": [64, 128]}, 
                "num_classes": {"value": 10},
                # load resnet
                # "load_res": {"value": True},
                # "res_path": {"value": "./MNIST/saved_weights/ResNet_MNIST/00_00/sim1.pt"},
                # "freeze_res": {"value": True},
                # DTM parameters
                "use_dtm": {"value": True},
                "m0_1": {"value": 0.05},
                "m0_2": {"value": 0.2},
                ...
                # # load eclay
                # "load_ec": {"value": True},
                # "ec_path": {"value": "./MNIST/saved_weights/EClay_MNIST/00_00/sim1.pt"},
                # "freeze_ec": {"value": True}
            }
        },
    ...
    "description": f"Hyperparameter search of ECResNet on {args.data} using 1000 train data"
}
...
if __name__ == "__main__":
    ...
    train_pipeline = partial(train_val_wandb, EClayResNet, None, x_path_list[0], y_path, seed, project=project)

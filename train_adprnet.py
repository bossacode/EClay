...
import wandb
import argparse
from models import ResidualBlock, AdPllayResNet
...
parser.add_argument("data", help="directory of where the 'generated data' folder is located")
...
config = {
    ...
    "model_params":{"in_channels":3, "block":ResidualBlock, "cfg":[2,2,2], "num_classes":7},
    "data": args.data,

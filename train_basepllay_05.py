...
import wandb
import argparse
from models_base import BasePllay_05
...
project = "BasePllay_05" + args.data
...
config = {
    ...
    "es_patience": 1,      # earlystopping patience
...
if __name__ == "__main__":
    ...
    for i_cn in range(len_cn):
        ...
        for n_sim in range(1, config["ntimes"]+1):
            ...
            model = BasePllay_05(**config["model_params"]).to(config["device"])
